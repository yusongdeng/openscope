...
ava('throws when called with invalid winds aloft data', (t) => {
    t.throws(() => new AtmosphereModel(SFC_WX, undefined));
    t.throws(() => new AtmosphereModel(SFC_WX, {}));
    t.throws(() => new AtmosphereModel(SFC_WX, 42));
    t.throws(() => new AtmosphereModel(SFC_WX, 'threeve'));
    t.throws(() => new AtmosphereModel(SFC_WX, false));
});

ava('does not throw when called with valid data', (t) => {
    t.notThrows(() => new AtmosphereModel(SFC_WX));
    t.notThrows(() => new AtmosphereModel(SFC_WX, WINDS_ALOFT));
});
